 ...
 * @author bmmar
 */
@WebServlet(name = "PasajController", urlPatterns = {"/Cliente/PasajController"})
public class PasajController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String nroDoc = request.getParameter("doc_nro");
        
        Documento doc = new Documento(nroDoc,typeDoc);
        ...
        Pasajero pasajero = new Pasajero(name,lastName,birthday,cellphone,sex,mail,doc);
        ...
        System.out.println("Documento - Número: " + pasajero.getDoc().getNro());
